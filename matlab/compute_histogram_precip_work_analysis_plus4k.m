...
ncfile = '/scratch/gpfs/mbolot/results/GLOBALFV3/work_histograms_PLUS_4K_CO2_1270ppmv/hist_2020010300_2022012000.nc';
...
% Schedule-aware time weighting (same logic as compute_global_work_average_plus4k.m)
...
xlim([min(pr_centers), 2e-2]);
xlabel('Precipitation bin center');
ylabel('Frequency');
title('+4K: Time-Mean Area-Weighted Precipitation Frequency');
grid on;
...
xlim([min(pr_centers), 2e-2]);
xlabel('Precipitation bin center');
title('+4K: Time-Mean Lift and Work in Precipitation Bins');
